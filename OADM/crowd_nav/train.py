...
from crowd_sim.envs.utils.plot_map import plot
...
def main():
    ...
    if args.resume:
        ...
        explorer.run_k_episodes(100, 'train', update_memory=False, episode=0)
        logging.info('Experience set size: %d/%d', len(memory), memory.capacity)
    episode = 0
    while episode < train_episodes:
        ...
        explorer.run_k_episodes(sample_episodes, 'train', update_memory=False, episode=episode)
        if episode >=1000:
